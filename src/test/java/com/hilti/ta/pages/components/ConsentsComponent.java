...
public class ConsentsComponent extends PageObject {
    ...
    private By consentBanner = By.xpath("//div[contains(@id,'didomi')][1]//div[contains(@class,'notice__')]");
    private By acceptCookieSettingsButton = By.xpath("//div[@id='didomi-custom-host']//a[contains(@class, 'a-button-primary accept_button')]");
    private By cookieSettings = By.xpath("//div[contains(@id,'didomi')][1]//div[contains(@id,'didomi')]");
    private By denyButton = By.xpath("(//div[contains(@id,'didomi')][1]//div[contains(@class,'bottom_')]//a)[last()-1]");
